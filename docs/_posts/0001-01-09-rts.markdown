...
In other words, boundary pixels do become brigher and darker as the silhouette boundary moves.
...
What should happen is that the grey pixel of the plane should slide underneath the white pixel of the sphere, leaving the white pixel unchanged.
